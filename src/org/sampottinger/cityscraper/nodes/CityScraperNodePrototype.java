...
{
	/**
	 * Get a small icon preview of the target node that can be used when placing
	 * an instance of.
	 * @return Small preview image of the node
	 */
	public <T extends PhineasPlaceable & PhineasBoundable & PhineasDrawable> T
			getPreview();
	 ...
	 * @throws IOException Thrown if the graphic for the node could not be
	 * 		loaded.
	 */
