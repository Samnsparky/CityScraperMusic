...
/**
 * Interface for factories that produce node prototypes and their selection toggle buttons
...
public interface NodeTypeInitializer
{
	 ...
	 *                        node's selection button and integrate it into a 
	 *                        larger toggle group 
	 ...
	 */
	public Iterable<ToggleButton> createAndRegisterButtons(int x, int y, int verticalPadding, 
			int bgDepth, int fgDepth, NodeTypeSelectorStateManager selectorManager) throws IOException, PhineasException;
}
