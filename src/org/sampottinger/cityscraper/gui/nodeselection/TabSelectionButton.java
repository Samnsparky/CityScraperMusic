...
public class TabSelectionButton extends ToggleUnderlineButton
{
	...
	/**
	 * Creates a new button at the given coordiante with the given image for the
	 * given tab type.
	 * @param newX The x (pixel) coordinate of this button.
	 * @param newY The y (pixel) coordinate of this button.
	 * @param newInactiveLoc The location of the image to use when this button
	 * 		is not activated.
	 * @param newActiveLoc The location if the image to use when this button has
	 * 		been clicked on and is active.
